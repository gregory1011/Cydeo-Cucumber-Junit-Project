...
public class DataTables_stepDefinitions {
    ...
    public void user_should_see_below_list(List<String> fruitsVegetables) {

        System.out.println("fruitsVegetables = " + fruitsVegetables);
        System.out.println(fruitsVegetables.get(1));
    ...
    public void i_will_share_my_favorites(List<String> petsList) {
